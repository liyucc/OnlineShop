...
function checkUsername(){
	...
	//3.打开链接
	uri="${pageContext.request.contextPath}/user_findUserByUsername.action?username="+username+"&time="+new Date().getTime();
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action" method="post" onsubmit="return checkForm();" >
						<table>
							...
							<tr>
								...
								<td>
									<span class="fieldSet">
										<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" /><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change();" title="点击更换验证码"/>
										<s:actionerror />
									</span>
								</td>
							</tr>
